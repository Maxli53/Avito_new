...
class AvitoAPITester:
    ...
    def test_account_info(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"❌ Account info request failed")
                print(f"Response: {response.text}")
                return False
    ...
    def test_autoload_operations(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("✅ Autoload operations retrieved:")
                print(json.dumps(operations_data, indent=2, ensure_ascii=False))
                return True
            else:
                print(f"❌ Autoload operations request failed")
                print(f"Response: {response.text}")
                return False
                
        except Exception as e:
            print(f"❌ Autoload operations error: {str(e)}")
            return False
    ...
    def test_items_stats(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("✅ Items statistics retrieved:")
                print(json.dumps(stats_data, indent=2, ensure_ascii=False))
                return True
            else:
                print(f"❌ Items statistics request failed")
                print(f"Response: {response.text}")
                return False
                
        except Exception as e:
            print(f"❌ Items statistics error: {str(e)}")
            return False
    ...
    def run_all_tests(self):
        ...
        if results['auth']:
            ...
            print("❌ Skipping other tests due to authentication failure")
